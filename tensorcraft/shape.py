...
from tensorcraft.types import Index, IndexTuple, MemLayout
...
class Shape:
    ...
    def getItem(self, item: int) -> Index:
        """
    ...
    def getMultiIndex(self, index: Index, order: MemLayout = "R") -> IndexTuple:
        """
        Convert a linear index to multi-dimensional indices.
